...
func TestStack(t *testing.T) {
	...
	t.Run("generic stack", func(t *testing.T) {
		...
		// add another thing, pop it back again
		myStackOfInts.Push(456)
		intValue, _ := myStackOfInts.Pop()
		AssertEqual(t, intValue, 456)
		intValue, _ = myStackOfInts.Pop()
		AssertEqual(t, intValue, 123)
		AssertTrue(t, myStackOfInts.IsEmpty())
		...
		// add another thing, pop it back again
		myStackOfStrings.Push("456")
		stringValue, _ := myStackOfStrings.Pop()
		AssertEqual(t, stringValue, "456")
		stringValue, _ = myStackOfStrings.Pop()
		AssertEqual(t, stringValue, "123")
		AssertTrue(t, myStackOfStrings.IsEmpty())
	})
}
